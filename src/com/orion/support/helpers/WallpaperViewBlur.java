...
public class WallpaperViewBlur extends ImageView {

    Context contextM;

    public WallpaperViewBlur(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        contextM = context;
        setRenderEffect(RenderEffect.createBlurEffect(15, 15, Shader.TileMode.CLAMP));
    }

    public WallpaperViewBlur(Context context, AttributeSet attrs) {
        super(context, attrs);
        contextM = context;
        setRenderEffect(RenderEffect.createBlurEffect(15, 15, Shader.TileMode.CLAMP));
    }
    ...
    public WallpaperViewBlur(Context context) {
        super(context);
        contextM = context;
        setRenderEffect(RenderEffect.createBlurEffect(15, 15, Shader.TileMode.CLAMP));
    }
