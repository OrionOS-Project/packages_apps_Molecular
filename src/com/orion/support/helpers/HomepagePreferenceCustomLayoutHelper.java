...
public class HomepagePreferenceCustomLayoutHelper {
    ...
    public interface HomepagePreferenceCustomLayout {
        /** Returns a {@link HomepagePreferenceCustomLayoutHelper}  */
        HomepagePreferenceCustomLayoutHelper getHelper();
    }

    public HomepagePreferenceCustomLayoutHelper(Preference preference) {
        preference.setLayoutResource(R.layout.homepage_preference_orion);
    }
