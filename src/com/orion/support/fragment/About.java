...
public class About extends SettingsPreferenceFragment implements View.OnClickListener {
    ...
    private static final Uri FOUNDER_URI_DATA = Uri.parse("https://orionos.tech/developer");
    private static final Uri CO_FOUNDER_URI_DATA = Uri.parse("https://orionos.tech/developer");
    private static final Uri CORE_DEV_URI_DATA = Uri.parse("https://orionos.tech/developer");
    private static final Uri UI_UX_URI_DATA = Uri.parse("https://orionos.tech/developer");
    private static final Uri SUPPORTING_URI_DATA = Uri.parse("https://orionos.tech/developer");
    private static final Uri CONTRIBUTOR_URI_DATA = Uri.parse("https://orionos.tech/developer");
