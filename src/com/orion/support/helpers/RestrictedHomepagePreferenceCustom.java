...
public class RestrictedHomepagePreferenceCustom extends RestrictedTopLevelPreference implements
    ...
    public RestrictedHomepagePreferenceCustom(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
    ...
    public RestrictedHomepagePreferenceCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
        mHelper = new HomepagePreferenceCustomLayoutHelper(this);
    }

    public RestrictedHomepagePreferenceCustom(Context context) {
        super(context);
        mHelper = new HomepagePreferenceCustomLayoutHelper(this);
    }
