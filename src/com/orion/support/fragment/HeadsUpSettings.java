...
import org.neoteric.preference.PackageListAdapter;
import org.neoteric.preference.PackageListAdapter.PackageItem;
...
public class HeadsUpSettings extends SettingsPreferenceFragment implements
    ...
    private static final String PREF_ADD_STOP = "add_stoplist_packages";
    private static final String PREF_ADD_BLACK = "add_blacklist_packages";
    private static final String PREF_STOPLIST = "stoplist_applications";
    private static final String PREF_BLACKLIST = "blacklist_applications";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStoplistPrefList = (PreferenceGroup) findPreference(PREF_STOPLIST);
        mStoplistPrefList.setOrderingAsAdded(false);

        mBlacklistPrefList = (PreferenceGroup) findPreference(PREF_BLACKLIST);
        ...
        mAddStoplistPref = findPreference(PREF_ADD_STOP);
        mAddBlacklistPref = findPreference(PREF_ADD_BLACK);
